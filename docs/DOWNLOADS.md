...
| Windows 可重建源码包 | [NFE_MXene_Studio_1.0_Source_20260730_2310.zip](https://github.com/Ruckker/Ruck-NFE-MXene-Studio/releases/latest/download/NFE_MXene_Studio_1.0_Source_20260730_2310.zip) | `6E5E529DEBC89296D18106F7E32410365A16304C6BB849F192F2E74588BFFF74` |
| Windows 完整程序分卷 1 | [NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part01](https://github.com/Ruckker/Ruck-NFE-MXene-Studio/releases/latest/download/NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part01) | `6A86AE1FB43F27171209987E2C09908088511A45AE0FC8728DF7796D8A72820C` |
| Windows 完整程序分卷 2 | [NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part02](https://github.com/Ruckker/Ruck-NFE-MXene-Studio/releases/latest/download/NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part02) | `FB3A973A5704FA21B71F5913A7DE4059137A7160A0C21A7A65934881589430F7` |
...
└─ windows/
   ├─ NFE_MXene_Studio_1.0_Source_20260730_2310.zip
   ├─ NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part01
   └─ NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part02
```
...
Windows 程序原始 ZIP 为 2,852,609,561 字节，超过 GitHub 单个 Release 附件的
2 GiB 限制，因此发布为两个分卷。下载两个分卷后，在仓库根目录运行：

```bash
python scripts/reassemble_release_parts.py \
  release_assets/windows/NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part01 \
  release_assets/windows/NFE_MXene_Studio_1.0_Windows_20260730_2300.zip.part02 \
  --output release_assets/windows/NFE_MXene_Studio_1.0_Windows_20260730_2300.zip \
  --sha256 CB37A156E74AB949909A8E74B10842361BAF49479A611E4BD37D7879463768F7
```

校验通过后再解压生成的 ZIP。脚本不会覆盖已有 ZIP，也不会删除任何分卷。

本时间戳构建修复了“严格生成两次均无候选后 GUI 保持忙碌”的问题，并加入扩大
CHGNet 复评池、弛豫后类别/概率诊断及请求骨架训练参考分布。
